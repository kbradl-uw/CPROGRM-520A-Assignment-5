...
namespace TestHuntTheWumpus
{
    ...
    {
        constexpr HuntTheWumpus::DenizenIdentifier thing1{ HuntTheWumpus::Category::Arrow, 0 };
        constexpr HuntTheWumpus::DenizenIdentifier thing2{ HuntTheWumpus::Category::Bat, 0 };
        constexpr HuntTheWumpus::DenizenIdentifier thing3{ HuntTheWumpus::Category::Bat, 1 };
        constexpr HuntTheWumpus::DenizenIdentifier thing4{ HuntTheWumpus::Category::Bat, 1 };
